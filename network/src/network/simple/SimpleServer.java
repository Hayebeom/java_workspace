...
public class SimpleServer {
	...
	public static void main(String[] args) throws Exception {
		// ServerSocket
		//		클라이언트의 연결요청을 기다리는 객체
		//		클라이언트의 연결요청이 접수되면, 해당 클라이언트와 데이터 교환을 담당하는 Socket객체를 반환
		...
		// 서버소켓의 accept() 메서드는 클라이언트의 연결이 접수되면 실행되는 메서드
		// 클라이언트의 연결요청이 접수되면 accept()가 실행되고,
		// 연결을 요청한 클라이언트와 데이터 교환을 할 Socket객체가 제공됨
